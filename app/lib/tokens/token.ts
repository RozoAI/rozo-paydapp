...
export const celoCelo: Token = token({
	...
	alchemyNetwork: celo.alchemyNetwork,
});
...
export const ethereumWETH: Token = token({
	...
	symbol: "WETH",
	logoURI: TokenLogo.WETH,
	alchemyNetwork: ethereum.alchemyNetwork,
});
...
export const lineaWETH: Token = token({
	...
	symbol: "WETH",
	logoURI: TokenLogo.WETH,
	alchemyNetwork: linea.alchemyNetwork,
});
...
export const mantleMNT = nativeToken({
	...
	alchemyNetwork: mantle.alchemyNetwork,
});
...
export const optimismWETH: Token = token({
	...
	symbol: "WETH",
	logoURI: TokenLogo.WETH,
	alchemyNetwork: optimism.alchemyNetwork,
});
...
export const worldchainWETH: Token = token({
	...
	symbol: "WETH",
	logoURI: TokenLogo.WETH,
	alchemyNetwork: worldchain.alchemyNetwork,
});
...
const knownTokensByAlchemyNetwork = new Map<Network, Token[]>([
	[arbitrum.alchemyNetwork, arbitrumTokens],
	[base.alchemyNetwork, baseTokens],
	[bsc.alchemyNetwork, bscTokens],
	[celo.alchemyNetwork, celoTokens],
	[ethereum.alchemyNetwork, ethereumTokens],
	// [linea.alchemyNetwork, lineaTokens],
	// [mantle.alchemyNetwork, mantleTokens],
	// [optimism.alchemyNetwork, optimismTokens],
	// [polygon.alchemyNetwork, polygonTokens],
	// [solana.alchemyNetwork, solanaTokens],
	// [worldchain.alchemyNetwork, worldchainTokens],
]);
